...
def insert_manifest2_owner_sigs(input_manifest_file, ecc_sig_file, lms_sig_file, output_manifest_file):
    try:
        ...
        print(f"Successfully inserted signatures into manifest2: {output_manifest_file}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Insert manifest2 owner ECC & LMS signatures into a SoC manifest file."
    )
